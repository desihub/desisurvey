...
# -*- coding: utf-8 -*-
"""
desisurvey.test.desisurvey_test_suite
=====================================
...
def runtests():
    """Run all tests in desisurvey.test.test_*.
    """
    # Load all TestCase classes from desisurvey/test/test_*.py
    tests = desisurvey_test_suite()
    # Run them
